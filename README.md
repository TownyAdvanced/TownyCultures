...
- If the "Preset Cultures" feature is *enabled*, culture names and descriptions are setup by the server, and can be based on the game-world location of the town e.g.
